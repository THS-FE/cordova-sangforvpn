...
typedef NS_ENUM(int,LoginProgress) {
    LOGIN_START_SELECT_LINE = 10,
    LOGIN_SELECT_LINE_OK_BEGIN_INIT = 30,
    LOGIN_INIT_OK_BEGIN_AUTH = 50,
    LOGIN_START_AUTH_OK_BEGIN_START_SERVER = 95,
    LOGIN_START_SERVER_OK = 100,
};
 ...
 */
@protocol SangforAuthDelegate<NSObject>
...
@optional
// 更新VPN登录进度
- (void)onUpdateLoginProgressInfo:(LoginProgress)loginProgress;
...
/*!
 当VPN失败时候附加在UserInfo中的AuthMessage Key值
 */
FOUNDATION_EXPORT NSString * const VPNErrorInfoAuthMessageKey;
